...
export const projects: Project[] = [
  ...
  },
  {
    ...
    process: [
      ...
      "Built one design system across four subsidiaries so shared journeys stayed consistent while local requirements, languages and regulatory copy could vary — the group reads as one bank, each market keeps what it needs.",
